...
class GameStore
  ...
  def save_data
    ...
    if File.exist?('./data/games.json')
      ...
      existing_authors = existing_data[:authors] || [] # Initialize as an empty array if it's nil
      data[:games] += existing_data[:games] if existing_data[:games]
      data[:authors] += existing_authors
    end
